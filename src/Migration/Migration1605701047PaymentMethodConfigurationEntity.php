...
class Migration1605701047PaymentMethodConfigurationEntity extends MigrationStep {
	...
	{
		$connection->executeUpdate('ALTER TABLE `weareplanet_payment_method_configuration` CHANGE `payment_method_configuration_id` `payment_method_configuration_id` bigint unsigned NOT NULL AFTER `data`;');
	}
