    ...
    const WeArePlanetCheckout = {
        ...
        getIframe: function () {
            ...
            if (!WeArePlanetCheckout.handler) { // iframe has not been loaded yet
                ...
                // noinspection JSUnresolvedFunction
                WeArePlanetCheckout.handler.setValidationCallback((validationResult) => {
                    WeArePlanetCheckout.hideErrors();
                    WeArePlanetCheckout.validationCallBack(validationResult);
                });
                WeArePlanetCheckout.handler.setInitializeCallback(() => {
                    let loader = document.getElementById(WeArePlanetCheckout.loader_id);
                    loader.parentNode.removeChild(loader);
                    WeArePlanetCheckout.activateLoader(false);
                });
                WeArePlanetCheckout.handler.setHeightChangeCallback((height)=>{
